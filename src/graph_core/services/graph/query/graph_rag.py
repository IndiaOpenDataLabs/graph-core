    ...
    return await llm_provider.chat([
        {
            ...
            "content": (
                ...
                "\n\nIf an Internal Higher-Level Context section is present, use it only for internal navigation: "
                "it may help you identify which lower-level or base-level entities matter. Do not quote, name, "

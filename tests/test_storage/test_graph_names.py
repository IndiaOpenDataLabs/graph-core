...
def test_collection_graph_name_uses_readable_slug():
    ...
    assert (
        graph_name == "tenant:87654321-4321-8765-4321-876543218765:collection:"
        "collection_ayurveda_corpus_v2_12345678"
    )


def test_collection_graph_name_without_namespace_keeps_legacy_shape():
    collection_id = uuid.UUID("12345678-1234-5678-1234-567812345678")
